...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Scoreboard_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Scoreboard_t qt_meta_stringdata_Scoreboard = {
    {
        QT_MOC_LITERAL(0, 10),  // "Scoreboard"
        QT_MOC_LITERAL(11, 12),  // "updateScores"
        QT_MOC_LITERAL(24, 0)   // ""
    },
    "Scoreboard",
    "updateScores",
...
Q_CONSTINIT static const uint qt_meta_data_Scoreboard[] = {
...
Q_CONSTINIT const QMetaObject Scoreboard::staticMetaObject = { {
    ...
    qt_meta_stringdata_Scoreboard.offsetsAndSizes,
    qt_meta_data_Scoreboard,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Scoreboard_t,
        // Q_OBJECT / Q_GADGET
