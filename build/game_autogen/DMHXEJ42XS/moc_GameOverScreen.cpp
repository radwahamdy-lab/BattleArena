...
Q_CONSTINIT static const qt_meta_stringdata_GameOverScreen_t qt_meta_stringdata_GameOverScreen = {
    {
        ...
        QT_MOC_LITERAL(15, 16),  // "playAgainClicked"
        QT_MOC_LITERAL(32, 0)   // ""
    },
    "GameOverScreen",
    "playAgainClicked",
...
void GameOverScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->playAgainClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameOverScreen::playAgainClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameOverScreen::playAgainClicked()
{
