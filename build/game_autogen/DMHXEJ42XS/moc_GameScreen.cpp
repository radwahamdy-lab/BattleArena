...
Q_CONSTINIT static const qt_meta_stringdata_GameScreen_t qt_meta_stringdata_GameScreen = {
    {
        ...
        QT_MOC_LITERAL(11, 17),  // "quitButtonClicked"
        QT_MOC_LITERAL(29, 0)   // ""
    },
    "GameScreen",
    "quitButtonClicked",
...
void GameScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameScreen::quitButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameScreen::quitButtonClicked()
{
