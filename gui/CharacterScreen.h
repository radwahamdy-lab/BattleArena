...
private:
    ...
    void startSelectedGame(QStackedWidget* stackedwid) {
        Game* game = new Game(userCharacter, computerCharacter, stackedwid, characterPage);
